...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapRoute("HomePageNewProductsConfigure", "/Admin/WidgetsHomePageNewProducts/Configure",
             new { controller = "WidgetsHomePageNewProducts", action = "Configure" });
